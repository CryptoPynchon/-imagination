...
Video.create(title: "2-3 NO DAMAGE", url: "https://www.youtube.com/embed/65807SpIUSw", thumbnail: "https://i3.ytimg.com/vi/65807SpIUSw", description: "saw a thumbnail for a no damage run in RE4 and for some reason it reminded me of the rapper CRIMEWAVE. one thing lead to another and now Leon is officially off the shits.", genre: "time sculptures")
